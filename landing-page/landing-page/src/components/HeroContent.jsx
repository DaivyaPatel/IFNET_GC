...
export default function HeroContent() {
  ...
  useEffect(() => {
    function handleClickOutside(event) {
      if (satelliteRef.current && !satelliteRef.current.contains(event.target)) {
        setShowSatelliteInfo(false);
      }
    }

    if (showSatelliteInfo) {
    ...
    <div className="hero-content">
      ...
      <div className="hero-left-zone">
        <h1 className="hero-title font-display">
          ...
          <br />
          <span className="title-gradient">
            <AnimatedText text="INTERPOLATION" startDelay={0.6} />
          </span>
        </h1>
      ...
      <div className="hero-right-zone" ref={satelliteRef}>
        <img
          src="/satellite.png"
          alt="Satellite"
          className="satellite-image"
          onClick={() => setShowSatelliteInfo(prev => !prev)}
